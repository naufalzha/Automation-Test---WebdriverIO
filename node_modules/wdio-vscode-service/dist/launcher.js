...
class VSCodeServiceLauncher extends wdio_chromedriver_service_1.launcher {
    constructor(_options, capabilities, config) {
    ...
    async onPrepare(_, capabilities) {
        ...
        for (const cap of caps) {
            ...
            if (!cap[constants_1.VSCODE_CAPABILITY_KEY]) {
                cap[constants_1.VSCODE_CAPABILITY_KEY] = {};
            }
            const version = cap.browserVersion || constants_1.DEFAULT_CHANNEL;
            if (versionsFileExist) {
                ...
                if (content[version] && await (0, utils_1.fileExist)(chromedriverPath) && await (0, utils_1.fileExist)(vscodePath)) {
                    ...
                    cap[constants_1.VSCODE_CAPABILITY_KEY].binary = await this._setupVSCode(content[version].vscode);
            ...
            const serviceArgs = {
                ...
                vscode: {
                    ...
                    path: cap[constants_1.VSCODE_CAPABILITY_KEY]?.binary || await this._setupVSCode(vscodeVersion)
                }
            };
            Object.assign(cap, this.options);
