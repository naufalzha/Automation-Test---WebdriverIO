 ...
 * @category Menu
 */
export declare class WindowControls extends BasePage<typeof WindowControlsLocators> {
    bar: TitleBar;
    /**
     * @private
     */
    locatorKey: "WindowControls";
    constructor(locators: VSCodeLocatorMap, element?: ChainablePromiseElement<WebdriverIO.Element> | string, bar?: TitleBar);
    /**
