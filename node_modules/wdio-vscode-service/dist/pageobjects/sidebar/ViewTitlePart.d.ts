import { ElementWithContextMenu, IPageDecorator, BasePage, VSCodeLocatorMap } from '../utils';
...
export declare class TitleActionButton extends BasePage<typeof ViewTitlePartLocators> {
     ...
     */
    locatorKey: "ViewTitlePart";
    constructor(locators: VSCodeLocatorMap, title: string, viewTitle: ViewTitlePart);
    /**
