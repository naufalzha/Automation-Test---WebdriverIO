...
import { BasePage, IPageDecorator, VSCodeLocatorMap } from '../utils';
 ...
 * @category Sidebar
 */
export declare class WelcomeContentButton extends BasePage<typeof WelcomeContentLocators> {
    welcomeSection: WelcomeContentSection;
    /**
     * @private
     */
    locatorKey: "WelcomeContent";
    /**
     * @param panel  The panel containing the button in the welcome section
     * @param welcomeSection  The enclosing welcome section
     */
    constructor(locators: VSCodeLocatorMap, panel: ChainablePromiseElement<WebdriverIO.Element>, welcomeSection: WelcomeContentSection);
 ...
 * @category Sidebar
 */
export declare class WelcomeContentSection extends BasePage<typeof WelcomeContentLocators> {
    /**
     * @private
     */
    locatorKey: "WelcomeContent";
     ...
     */
    constructor(locators: VSCodeLocatorMap, panel: ChainablePromiseElement<WebdriverIO.Element>, parent: ViewSection);
    /**
...
//# sourceMappingURL=WelcomeContent.d.ts.map