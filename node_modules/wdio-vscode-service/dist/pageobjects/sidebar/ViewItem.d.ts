...
import { IPageDecorator, BasePage, ElementWithContextMenu, VSCodeLocatorMap } from '../utils';
import { ViewSection as ViewSectionLocators, TreeItem as TreeItemLocators, CustomTreeItem as CustomTreeItemLocators, DefaultTreeItem as DefaultTreeItemLocators, ExtensionsViewItem as ExtensionsViewItemLocators } from '../../locators/1.61.0';
/**
 * Abstract representation of a row in the tree inside a view content section
 * @hidden
 */
export declare type ViewItemLocators = (typeof ViewSectionLocators & typeof TreeItemLocators & typeof CustomTreeItemLocators & typeof DefaultTreeItemLocators & typeof ExtensionsViewItemLocators);
 ...
 * @category Sidebar
 */
export declare abstract class ViewItem extends ElementWithContextMenu<ViewItemLocators> {
    /**
...
export declare abstract class TreeItem extends ViewItem {
     ...
     */
    protected getChildItems(locator: string): Promise<WebdriverIO.Element[]>;
    protected findTwistie(): Promise<WebdriverIO.Element>;
}
 ...
 * @category Sidebar
 */
export declare class ViewItemAction extends BasePage<typeof ViewSectionLocators> {
    /**
     * @private
     */
    locatorKey: "ViewSection";
    private label;
    constructor(locators: VSCodeLocatorMap, label: string, viewItem: TreeItem);
    /**
