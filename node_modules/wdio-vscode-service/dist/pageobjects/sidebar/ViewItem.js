...
let ViewItemAction = class ViewItemAction extends utils_1.BasePage {
    constructor(locators, label, viewItem) {
        super(locators, locators.ViewSection.actionConstructor(label), viewItem.elem);
        /**
         * @private
         */
...
ViewItemAction = __decorate([
    (0, utils_1.PageDecorator)(_1_61_0_1.ViewSection)
], ViewItemAction);
