...
ViewTitlePart = __decorate([
    (0, utils_1.PageDecorator)(_1_61_0_1.ViewTitlePart)
], ViewTitlePart);
...
let TitleActionButton = class TitleActionButton extends utils_1.BasePage {
    constructor(locators, title, viewTitle) {
        super(locators, locators.ViewTitlePart.actionContstructor(title), viewTitle.elem);
        this.title = title;
        /**
         * @private
         */
