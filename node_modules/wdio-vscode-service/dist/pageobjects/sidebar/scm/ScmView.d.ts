...
import { ElementWithContextMenu, VSCodeLocatorMap, IPageDecorator, BasePage } from '../../utils';
 ...
 * @category Sidebar
 */
export declare class ScmView extends SideBarView<typeof ScmViewLocators> {
    /**
     * @private
     */
    locatorKey: "ScmView";
 ...
 * @category Sidebar
 */
export declare class ScmProvider extends BasePage<typeof ScmViewLocators> {
    view: ScmView;
    /**
     * @private
     */
    locatorKey: "ScmView";
    constructor(locators: VSCodeLocatorMap, element: ChainablePromiseElement<WebdriverIO.Element>, view: ScmView);
    /**
 ...
 * @category Sidebar
 */
export declare class ScmChange extends ElementWithContextMenu<typeof ScmViewLocators> {
    provider: ScmProvider;
    /**
     * @private
     */
    locatorKey: "ScmView";
    constructor(locators: VSCodeLocatorMap, row: ChainablePromiseElement<WebdriverIO.Element>, provider: ScmProvider);
    /**
 ...
 * @category Sidebar
 */
export declare class MoreAction extends ElementWithContextMenu<typeof ScmViewLocators> {
    scm: ScmProvider | ScmView;
    /**
     * @private
     */
    locatorKey: "ScmView";
    constructor(locators: VSCodeLocatorMap, scm: ScmProvider | ScmView);
    openContextMenu(): Promise<ContextMenu>;
}
//# sourceMappingURL=ScmView.d.ts.map