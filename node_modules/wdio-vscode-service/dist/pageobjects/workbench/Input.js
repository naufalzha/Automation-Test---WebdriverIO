...
class Input extends utils_1.BasePage {
    ...
    async setText(text) {
        ...
        if ((await this.getText()) !== text) {
            ...
            await input.addValue([constants_1.CMD_KEY, 'v']);
...
QuickPickItem = __decorate([
    (0, utils_1.PageDecorator)(_1_61_0_1.Input)
], QuickPickItem);
...
InputBox = __decorate([
    (0, utils_1.PageDecorator)({ ..._1_61_0_1.Input, ..._1_61_0_1.InputBox })
], InputBox);
...
QuickOpenBox = __decorate([
    (0, utils_1.PageDecorator)({ ..._1_61_0_1.Input, ..._1_61_0_1.QuickOpenBox })
], QuickOpenBox);
