...
import { BasePage, IPageDecorator } from '../utils';
 ...
 * @category Workbench
 */
export declare class NotificationsCenter extends BasePage<typeof NotificationsCenterLocator> {
    /**
     * @private
     */
    locatorKey: "NotificationsCenter";
    /**
