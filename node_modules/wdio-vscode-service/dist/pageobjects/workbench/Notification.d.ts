 ...
 * @category Workbench
 */
declare class NotificationButton extends BasePage<typeof NotificationLocators> {
    /**
     * @private
     */
    locatorKey: "Notification";
    private title;
    constructor(locators: VSCodeLocatorMap, title: string);
    getTitle(): string;
}
 ...
 * @category Workbench
 */
export declare abstract class Notification extends BasePage<typeof NotificationLocators> {
    /**
...
export declare class StandaloneNotification extends Notification {
     ...
     */
    locatorKey: "Notification";
    constructor(locators: VSCodeLocatorMap, notification: ChainablePromiseElement<WebdriverIO.Element>);
}
/**
